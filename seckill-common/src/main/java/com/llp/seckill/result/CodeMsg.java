package com.llp.seckill.result;
...
public class CodeMsg {
    ...
    public static CodeMsg TOKEN_INVALID = new CodeMsg(500213, "token失效");
    public static CodeMsg LOGINACCOUNT_NOT_EXIST = new CodeMsg(500214, "登录账户不存在");
    ...
    public static CodeMsg NOT_START = new CodeMsg(500501, "秒杀未开启");
